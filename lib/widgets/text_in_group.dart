...
class TextInGroup extends StatefulWidget {
  final Map device;

  TextInGroup(this.device);

  @override
  _TextInGroupState createState() => _TextInGroupState();
}

class _TextInGroupState extends State<TextInGroup> {
  @override
  Widget build(BuildContext context) {
    String desc = '';
    Color color;
    if (widget.device[ConfigCustom.sharedTextInbound] == ConfigCustom.yes) {
      desc = 'Inbound working';
      color = ConfigCustom.colorWhite;
    } else if (widget.device[ConfigCustom.sharedTextInbound] ==
        ConfigCustom.no) {
            ...
            Row(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Center(
                    child: ButtonCheck(
                        widget.device[ConfigCustom.sharedTextInbound]),
                  ),
                ),
              ],
            ),
