    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color:
              widget.device[ConfigCustom.sharedPointCamera] == ConfigCustom.yes
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Icon(
                    ...
                    size: 32,
                    color: widget.device[ConfigCustom.sharedPointCamera] ==
                            ConfigCustom.yes
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        TextCustom('Camera',
                            ...
                            fontSize: 18,
                            color:
                                widget.device[ConfigCustom.sharedPointCamera] ==
                                        ConfigCustom.yes
                                    ? ConfigCustom.colorWhite
                                    : ConfigCustom.colorErrorLight),
                        SizedBox(
                        ...
                        TextCustom(
                          widget.device[ConfigCustom.sharedPointCamera] ==
                              ...
                              : 'Camera not working',
                          fontSize: 13,
                          color: widget.device['camera'] == ConfigCustom.yes
                              ? ConfigCustom.colorWhite
                              : ConfigCustom.colorErrorLight,
                        ),
                      ],
                ...
                Padding(
                  ...
                  child: Center(
                    child: widget.device[ConfigCustom.sharedPointCamera] ==
                            ConfigCustom.yes
                        ? ButtonCheck('yes')
                        : ButtonCheck('no'),
                  ),
