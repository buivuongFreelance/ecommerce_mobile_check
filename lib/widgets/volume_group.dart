...
class VolumeGroup extends StatefulWidget {
  final Map device;

  VolumeGroup(this.device);

  @override
  _VolumeGroupState createState() => _VolumeGroupState();
}

class _VolumeGroupState extends State<VolumeGroup> {
  @override
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color:
              widget.device[ConfigCustom.sharedPointVolume] == ConfigCustom.yes
            ...
            Row(
              children: <Widget>[
                Container(
                  ...
                  child: Icon(
                    SimpleLineIcons.volume_1,
                    size: 32,
                    color: widget.device[ConfigCustom.sharedPointVolume] ==
                            ConfigCustom.yes
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        TextCustom('Volume',
                            ...
                            fontSize: 18,
                            color:
                                widget.device[ConfigCustom.sharedPointVolume] ==
                                        ConfigCustom.yes
                                    ? ConfigCustom.colorWhite
                                    : ConfigCustom.colorErrorLight),
                        SizedBox(
                        ...
                        TextCustom(
                          widget.device['volume'] == ConfigCustom.yes
                              ? 'Volume working'
                              : 'Volume not working',
                          fontSize: 13,
                          color:
                ...
                Padding(
                  ...
                  child: Center(
                    child: widget.device[ConfigCustom.sharedPointVolume] ==
                            ConfigCustom.yes
                        ? ButtonCheck('yes')
                        : ButtonCheck('no'),
                  ),
