...
class BluetoothGroup extends StatefulWidget {
  final Map device;

  BluetoothGroup(this.device);

  @override
  _BluetoothGroupState createState() => _BluetoothGroupState();
}

class _BluetoothGroupState extends State<BluetoothGroup> {
  @override
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: widget.device[ConfigCustom.sharedPointBluetooth] ==
                  ConfigCustom.yes
            ...
            Row(
              children: <Widget>[
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        TextCustom('Bluetooth',
                            ...
                            fontSize: 18,
                            color: widget.device[
                                        ConfigCustom.sharedPointBluetooth] ==
                                    ConfigCustom.yes
                                ? ConfigCustom.colorWhite
                                : ConfigCustom.colorErrorLight),
                        SizedBox(
                        ...
                        TextCustom(
                          widget.device[ConfigCustom.sharedPointBluetooth] ==
                                  ConfigCustom.yes
                              ? 'Bluetooth working'
                ...
                Padding(
                  ...
                  child: Center(
                    child: widget.device[ConfigCustom.sharedPointBluetooth] ==
                            ConfigCustom.yes
                        ? ButtonCheck('yes')
                        : ButtonCheck('no'),
                  ),
