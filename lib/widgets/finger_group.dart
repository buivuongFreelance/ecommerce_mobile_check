...
class FingerGroup extends StatefulWidget {
  final Map device;

  FingerGroup(this.device);

  @override
  _FingerGroupState createState() => _FingerGroupState();
}

class _FingerGroupState extends State<FingerGroup> {
  @override
  Widget build(BuildContext context) {
    return widget.device[ConfigCustom.sharedPointFinger] == ConfigCustom.nothave
        ? Center()
        : Column(
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: widget.device[ConfigCustom.sharedPointFinger] ==
                            ConfigCustom.yes
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Icon(
                              ...
                              size: 34,
                              color: widget.device[
                                          ConfigCustom.sharedPointFinger] ==
                                      ConfigCustom.yes
