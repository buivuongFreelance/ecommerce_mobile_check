...
class SpeakerGroup extends StatefulWidget {
  final Map device;

  SpeakerGroup(this.device);

  @override
  _SpeakerGroupState createState() => _SpeakerGroupState();
}

class _SpeakerGroupState extends State<SpeakerGroup> {
  @override
